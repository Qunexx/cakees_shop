                ...
                @foreach($cartItems as $item)
                    ...
                    <div class="form-group mt-4">
                        ...
                        <select id="paymentMethod" class="form-control" name="payment_method">
                            ...
                            @else
                                <option value="card" disabled>Картой из профиля (необходимо добавить карту в профиль)
                                </option>
                            @endif
                        ...
                        @if(!auth()->user())
                            <div class="alert alert-warning mt-3">
                                Ваша карта не добавлена в профиль. Пожалуйста, <a href="{{ route('profile.index') }}">добавьте
                                    информацию о вашей карте</a> для использования этого способа оплаты.
                            </div>
                        @endif
